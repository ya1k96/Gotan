...
class VistaDetallePedido extends StatefulWidget {
  VistaDetallePedido({Key key}) : super(key: key);

  @override
  _VistaDetallePedidoState createState() => _VistaDetallePedidoState();
}

class _VistaDetallePedidoState extends State<VistaDetallePedido> {
  Pedido pedido;
  bool _loading = false;
  @override
